...
# Construct the configuration file path in a platform-independent way
CONFIG_FILE_PATH = os_path.abspath(
    os_path.join(os_path.dirname(__file__), "..", "env_config.ini")
)
